...
const sendMail = async (email, subject, text) => {
    let transporter = nodemailer.createTransport({
        ...
        auth: {
          user: 'contact.ministore3821@gmail.com', // generated ethereal user
          pass: 'MiniStore$3821', // generated ethereal password
        },
      });
    
    let info = await transporter.sendMail({
        from: '"Jinesh Modi" <contact.ministore3821@gmail.com>', // sender address
